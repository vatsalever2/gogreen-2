      ...
      <Container size="wide">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 mb-10 sm:mb-14">
          ...
          <div className="lg:col-span-5 lg:pt-6 flex flex-col gap-2 text-[14px] text-muted">
            ...
            <div className="mt-4 flex items-center gap-3 lg:hidden text-muted text-[10px] font-mono uppercase tracking-[0.2em] font-medium">
        ...
        <div tabIndex={0} role="region" aria-label="Client testimonials" className="flex overflow-x-auto snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] -mx-6 px-6 lg:mx-0 lg:px-0 lg:grid lg:grid-cols-3 gap-6 pb-8 lg:pb-0">
          {items.map((t, i) => (
            <motion.figure
              key={i}
