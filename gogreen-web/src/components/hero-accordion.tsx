        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 xl:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
           ...
           <div className="col-span-1 lg:col-span-5 flex flex-col items-start">
             ...
             <motion.div 
               ...
               className="mt-10"
             >
               <Link href="/get-assessment" className="flex items-center justify-center w-max gap-2 h-14 px-8 rounded-full bg-accent-2 text-white font-medium hover:bg-accent hover:-translate-y-0.5 transition-all shadow-[0_0_20px_rgba(30,127,92,0.4)] group">
