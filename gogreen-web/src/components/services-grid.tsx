      ...
      <Container size="wide">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 mb-14">
          ...
          <div className="lg:col-span-5 lg:pt-4">
            ...
            <div className="mt-6 flex items-center gap-3 lg:hidden text-muted-2 text-[10px] font-mono uppercase tracking-[0.2em] font-medium">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] -mx-6 px-6 lg:mx-0 lg:px-0 lg:grid lg:grid-cols-3 gap-4 lg:gap-px lg:bg-line lg:border lg:border-line lg:rounded-3xl pb-8 lg:pb-0">
              ...
              >
                ...
                >
                  ...
                  <div className="mt-12 lg:mt-16">
                    <div className="text-[11px] uppercase tracking-[0.18em] text-muted-2 font-medium font-mono">
