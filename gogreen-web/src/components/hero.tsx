...
export function Hero() {
  ...
  return (
    <>
      ...
      */}
      <section className={`relative w-full min-h-[calc(100dvh-108px)] xl:min-h-0 xl:h-[calc(100dvh-148px)] bg-ink flex items-center justify-center pt-12 pb-12 xl:pt-0 xl:pb-0 overflow-hidden ${!isLoaded ? "opacity-0" : "opacity-100 transition-opacity duration-1000"}`}>
              ...
              <div className="flex gap-4 px-6 w-max pb-8">
                 {HERO_IMAGES.map((img, idx) => (
                   <div
                     ...
                     className="relative w-[85vw] sm:w-[60vw] lg:w-[45vw] h-[45vh] lg:h-[55vh] rounded-[32px] overflow-hidden snap-center border border-white/10 shrink-0 shadow-2xl focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
                   >
                      <Image 
                        src={img.src} 
                        alt={img.alt} 
